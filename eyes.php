...
<div id="logo">
	...
	<ul>
		...
		<li><a href="#palete"> <table><tr><td><img src="1.png" width="20%" /></td>
		<td>&nbsp;Eyes Make-up</td></tr></table></a></li>
...
<h3><center>Eyes Make-up</center></h3>
...
$sql="SELECT product_code, product_name, product_img_name, price FROM produse WHERE category='eyes' AND fandom='eyes'";
