      ...
      <form id="submitOrderForm" method="post" action="submit_order.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="fname" placeholder="Clepcea Beatrice" required>
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="text" id="email" name="email" placeholder="BEA@example.com" required>
            <label for="adr"><i class="fa fa-address-card-o"></i> Adresă</label>
            <input type="text" id="adr" name="adr" placeholder="STR. ANDREI MURESANU" required>
            ...
            <div class="row">
              <div class="col-50">
                ...
                <input type="text" id="state" name="state" placeholder="BIHOR" required>
              </div>
              <div class="col-50">
